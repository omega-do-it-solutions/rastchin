...
- Data flow and real-time delivery: application processing is local with no
  RastChin service or telemetry; no application API, polling, SSE, WebSockets,
  durable events, or queues
