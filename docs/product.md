...
- Chrome and Firefox ZIPs, VSIX files, and desktop installers are generated
  release artifacts. Routine package workflows retain CI artifacts for a limited
  period. An explicit release run
...
- Medium product scope because three client applications are maintained.
