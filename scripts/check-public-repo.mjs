...
const requiredPaths = [
  ...
  "plugins/rastchin-persian/.codex-plugin/plugin.json",
  "plugins/rastchin-persian/.claude-plugin/plugin.json",
  "plugins/rastchin-persian/LICENSE",
  "plugins/rastchin-persian/NOTICE",
  "plugins/rastchin-persian/README.md",
  "plugins/rastchin-persian/evals/README.md",
  "plugins/rastchin-persian/evals/cases.json",
  "plugins/rastchin-persian/evals/results/2026-09-01-smoke.md",
  "plugins/rastchin-persian/skills/rastchin-persian/SKILL.md",
  "plugins/rastchin-persian/skills/rastchin-persian/agents/openai.yaml",
  "plugins/rastchin-persian/skills/rastchin-persian/assets/rastchin-logo.png",
  ...
  "apps/browser-extension/scripts/build-firefox.sh",
  "apps/browser-extension/scripts/create-firefox-manifest.js",
  "apps/browser-extension/scripts/package-browser-zips.sh",
  "apps/browser-extension/scripts/package-firefox-zip.sh",
  "apps/browser-extension/scripts/verify-firefox.js",
  "apps/browser-extension/store/firefox/listing-fa.md",
  "apps/browser-extension/store/firefox/privacy-policy-fa.md",
  "apps/browser-extension/store/firefox/submission-checklist.md",
  "apps/browser-extension/test/firefox-package.test.js",
