...
var RastChinRecipe = (() => {
    ...
    function currentHostname() {
        return window.__RASTCHIN_DESKTOP_HOST__ || window.location.hostname;
    }
    ...
    function runPlatformRecipe(recipe) {
        ...
        if (!hostMatchesRecipe(recipe, currentHostname())) return null;
        ...
        if (!config) {
            enable();
            const handle = { engine, enable, disable, unsubscribe: () => {}, removeDebugOverlay };
