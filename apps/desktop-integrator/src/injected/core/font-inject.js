...
(() => {
    const FONT_URL = window.__RASTCHIN_DESKTOP_FONT_URL__
        || chrome.runtime.getURL("src/assets/fonts/Vazirmatn[wght].ttf");
    const FONT_URL_BOLD = window.__RASTCHIN_DESKTOP_FONT_BOLD_URL__ || FONT_URL;
    ...
    @font-face {
      font-family: "Vazirmatn";
      src: url(${JSON.stringify(FONT_URL_BOLD)}) format("woff2");
      font-weight: 601 900;
      font-style: normal;
      font-display: swap;
      unicode-range:
    ...
    function responseSkipSelector() {
        ...
        const hostname = window.__RASTCHIN_DESKTOP_HOST__ || window.location.hostname;
        return RESPONSE_SKIP_SELECTORS[hostname] || "";
    }
