...
### پخش زنده در Kick و Twitch

در Chrome و Firefox، پیام‌های فارسی چت، عنوان پخش زنده، معرفی کانال و کادر نوشتن پیام در Kick و Twitch پشتیبانی می‌شوند. پیام‌های انگلیسی‌محور ظاهر اصلی خود را حفظ می‌کنند. نام کاربری، نشان‌ها، شکلک‌ها، دکمه‌های چت و کنترل‌های پخش تغییر نمی‌کنند. هر سایت کلید روشن/خاموش جداگانه‌ای در گروه «ویدیو» دارد.
